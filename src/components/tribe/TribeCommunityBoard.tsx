    ...
    <div className="h-full flex flex-col bg-black animate-fadeIn overflow-x-hidden">
        ...
        <div className="px-4 py-1.5 border-b border-white/10 sticky top-0 bg-black/95 backdrop-blur-xl z-20 space-y-2">
            ...
            <a
              ...
              className="relative flex items-center gap-3 bg-gradient-to-r from-[#25D366] to-[#128C7E] hover:from-[#128C7E] hover:to-[#25D366] border-2 border-[#25D366] rounded-xl px-4 py-3.5 transition-all shadow-lg shadow-[#25D366]/40 hover:shadow-[#25D366]/60 hover:scale-[1.02] animate-pulse-subtle"
            >
              <svg viewBox="0 0 24 24" className="w-8 h-8 shrink-0 fill-white drop-shadow" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className="flex-1 min-w-0">
                <div className="text-base font-bold text-white tracking-wide">💬 Community Chat beitreten</div>
                <div className="text-xs text-white/90 truncate font-medium">Jetzt der WhatsApp-Gruppe beitreten →</div>
              </div>
