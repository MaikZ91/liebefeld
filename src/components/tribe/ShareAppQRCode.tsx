...
import { QrCode, Share2, X, Smartphone, Globe } from 'lucide-react';
...
// Dynamische URL für die Plattform-Auswahl
const SMART_LINK_URL = `${WEB_APP_URL}/app`;

export const ShareAppQRCode: React.FC = () => {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      <DialogTrigger asChild>
        <button className="flex items-center gap-2 px-3 py-2 bg-zinc-900 border border-gold/30 text-gold hover:bg-gold/10 transition-all text-xs uppercase tracking-widest">
          <QrCode size={14} />
          Teilen
        </button>
      </DialogTrigger>
      <DialogContent className="bg-zinc-950 border border-gold/30 text-white max-w-sm">
        <DialogHeader>
          <DialogTitle className="text-center text-white font-serif text-xl">
            THE TRIBE teilen
          </DialogTitle>
        </DialogHeader>
        ...
        {!showPlatformChoice ? (
          <div className="flex flex-col items-center py-4 space-y-6">
            ...
            <div className="bg-white p-3 rounded-xl shadow-lg">
              <img 
                src={`https://api.qrserver.com/v1/create-qr-code/?size=180x180&data=${encodeURIComponent(SMART_LINK_URL)}&color=000000&bgcolor=FFFFFF`}
            ...
            <p className="text-zinc-400 text-sm text-center px-4">
              Scanne den QR-Code oder teile den Link direkt mit deinen Freunden
            </p>
          ...
          <div className="flex flex-col items-center py-4 space-y-4">
            ...
            <h3 className="text-lg font-medium text-white">Wähle deine Plattform</h3>
            ...
            <div className="w-full space-y-3 px-4">
              ...
              >
                ...
                <div className="flex-1 text-left">
                  <p className="text-white font-medium">iOS (iPhone/iPad)</p>
