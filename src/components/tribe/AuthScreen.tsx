    ...
    <div className="min-h-screen bg-black text-white flex flex-col relative overflow-hidden">
      ...
      <div className="absolute inset-0 flex flex-col">
        ...
        <div className="relative h-[60%] overflow-hidden">
          {REEL_IMAGES.map((img, i) => (
            <img 
              ...
              style={{ 
                ...
                transform: topImageIndex === i ? 'scale(1.02)' : 'scale(1.05)',
              }}
            />
          ))}
          ...
          <div className="absolute bottom-20 left-4 z-20 flex -space-x-2">
          ...
          {REEL_IMAGES.map((img, i) => (
            <img 
              ...
              style={{ 
                ...
                transform: bottomImageIndex === i ? 'scale(1.02)' : 'scale(1.05)',
              }}
            />
          ))}
          {/* Event Counter Badge */}
      ...
      {/* Form Content - positioned absolutely at bottom */}
      <div className="absolute inset-x-0 bottom-0 z-30 w-full max-w-sm mx-auto px-6 pb-8">
        ...
        {/* One-Step Login Form with solid background */}
        <div className="space-y-4 animate-fadeIn bg-black/80 backdrop-blur-md p-5 rounded-2xl border border-white/10">
          ...
          <div className="space-y-3">
            <div className="relative">
              <input 
                ...
                className="w-full bg-zinc-900/80 border border-white/20 rounded-lg py-3 text-center text-lg font-serif text-white placeholder-zinc-500 outline-none focus:border-gold transition-colors"
                autoFocus
            ...
            <select 
              ...
              className="w-full bg-zinc-900/80 border border-white/20 text-white text-sm p-2.5 outline-none focus:border-gold transition-colors rounded-lg"
            >
          ...
          <button 
            ...
            className="w-full bg-gold text-black py-3.5 font-bold uppercase tracking-widest text-xs flex items-center justify-center gap-2 hover:bg-white transition-colors disabled:opacity-40 disabled:hover:bg-gold rounded-lg shadow-[0_0_30px_rgba(212,180,131,0.3)]"
          >
            <Sparkles size={14} />
            Los geht's
            <ArrowRight size={14} />
        ...
        <button 
          ...
          className="text-zinc-500 text-[9px] hover:text-zinc-300 transition-colors mx-auto block mt-3"
        >
