...
const EventHeatmap: React.FC = () => {
  ...
  return (
    <div className="relative w-full h-full overflow-hidden" style={{ height: "100dvh" }}>
      ...
      <style>{`
        .map-container {
          background: linear-gradient(135deg, #3d1a1a 0%, #2b1111 50%, #1a0a0a 100%) !important;
        }
        .map-container .leaflet-layer,
        .map-container .leaflet-tile-pane,
        .map-container .leaflet-tile {
          filter: sepia(80%) saturate(200%) hue-rotate(340deg) brightness(0.4) contrast(1.8) !important;
        }
      ...
      {showAiResponse && !isOnboardingActive && (
        <div className="fixed top-20 right-4 left-4 md:left-auto md:w-[520px] z-[10000] animate-fade-in">
