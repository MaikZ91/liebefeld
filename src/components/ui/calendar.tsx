  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        caption_label: "text-lg font-medium text-white", // Increased size and improved contrast
        ...
        head_row: "flex",
        head_cell:
          "text-white rounded-md w-10 font-medium text-[0.9rem]", // Improved header cell visibility
        row: "flex w-full mt-2",
        cell: "h-10 w-10 text-center text-sm p-0 relative [&:has([aria-selected].day-range-end)]:rounded-r-md [&:has([aria-selected].day-outside)]:bg-accent/50 [&:has([aria-selected])]:bg-accent first:[&:has([aria-selected])]:rounded-l-md last:[&:has([aria-selected])]:rounded-r-md focus-within:relative focus-within:z-20",
        day: cn(
          buttonVariants({ variant: "ghost" }),
          "h-10 w-10 p-0 font-normal text-white hover:bg-gray-700 hover:text-white" // Improved day cell visibility
        ),
