          ...
          Object.keys(eventsByDate).sort().map(dateStr => {
            ...
            return (
              <div 
                ...
                className={`mb-4 ${isCurrentDay ? 'scroll-mt-12' : ''} w-full`}
                id={isCurrentDay ? "today-section" : undefined}
              >
                <h4 className="text-sm font-medium mb-2 text-white sticky top-0 bg-[#131722]/95 backdrop-blur-sm py-2 z-10 rounded-md flex items-center w-full">
