...
export const EventMessageFormatter: React.FC<{ event: EventShare }> = ({ event }) => {
  return (
    <div className="bg-gray-800 rounded-lg p-3 border border-red-500/30 w-full overflow-hidden">
      <div className="text-sm font-semibold text-white mb-1">Geteiltes Event</div>
      <div className="text-lg font-bold text-white truncate">{event.title}</div>
