    ...
    <div className="flex items-center relative w-full max-w-md">
      ...
      <Textarea
        ...
        rows={1} // Start with 1 row
          className={cn(
            "w-full bg-background/60 backdrop-blur supports-[backdrop-filter]:backdrop-blur-md border-0 rounded-xl py-2 focus:outline-none text-sm text-foreground placeholder:text-muted-foreground pr-10 transition-all duration-200 text-left min-h-[40px] overflow-hidden flex items-center",
            getButtonWidth()
          )}
