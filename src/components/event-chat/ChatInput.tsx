  ...
  return (
    <div className="flex items-end relative w-full max-w-md">
      ...
      <Textarea
        ...
        className={cn(
          "w-full bg-black border-2 border-gray-700/50 rounded-xl py-2 focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-red-500 text-sm text-white placeholder-white-400 pr-10 transition-all duration-200 hover:border-red-600 text-left min-h-[40px] overflow-hidden",
          getButtonWidth()
        )}
      />
