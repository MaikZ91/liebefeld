            ...
            {activeChatModeValue === 'ai' && (
              <div className="flex items-center relative">
                ...
                <input
                  ...
                  onKeyPress={handleKeyPress}
                  placeholder="Frage nach Events..."
                  className="flex-1 bg-zinc-900/50 dark:bg-zinc-800/50 border border-red-500/20 rounded-full px-4 py-2 focus:outline-none focus:ring-2 focus:ring-red-500 text-sm text-red-200 placeholder-red-200/50 pl-16 pr-10"
                />
                <button
                  onClick={() => handleSendMessage()}
                  disabled={!input.trim() || isTyping}
