        ...
        <div className="relative w-full h-[50vh] overflow-hidden bg-black">
          ...
          <div className="relative z-10 h-full flex flex-col items-center justify-center text-white px-4">
            ...
            <div className="flex flex-col items-center justify-center gap-3 w-full max-w-xl">
              ...
              >
                <Button 
                  className="bg-green-600 hover:bg-green-700 text-white flex items-center gap-2 rounded-full px-4 py-2 text-sm transition-all shadow-lg hover:shadow-xl w-full"
                >
