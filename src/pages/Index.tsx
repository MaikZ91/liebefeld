            ...
            {showCircle && (
              ...
              >
                <div className="text-white text-center">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24" className="w-12 h-12 mb-1">
                  ...
                  <div className="text-xs whitespace-normal px-1">Verbinde dich in unserer Community</div>
                </div>
              </div>
            )}
