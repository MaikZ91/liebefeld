          ...
          <div className="relative z-10 h-full flex flex-col items-center justify-center text-white px-4 pt-2">
            ...
            <div className="transition-opacity duration-500 ease-in-out mt-16 flex flex-col items-center">
              ...
              <Button 
                ...
                className="bg-[#25D366] hover:bg-[#128C7E] text-white rounded-full px-6 py-6 flex items-center justify-center shadow-xl hover:shadow-2xl transition-all gap-2 animate-bounce-slow border-2 border-white/30 mb-10"
                size="lg"
              >
