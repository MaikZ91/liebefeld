      ...
      <main className="flex-grow">
        <div className="relative w-full h-[50vh] overflow-hidden bg-black">
          ...
          <div className="relative z-10 h-full flex flex-col items-center justify-center text-white px-4">
            ...
            <div className="flex items-center justify-center gap-2 flex-wrap w-full max-w-xl">
              <a 
              ...
              >
                <Button 
                  className="bg-green-600 hover:bg-green-700 text-white flex items-center gap-1 rounded-full px-3 py-1.5 text-xs sm:text-sm transition-all shadow-lg hover:shadow-xl"
                  size="sm"
                >
