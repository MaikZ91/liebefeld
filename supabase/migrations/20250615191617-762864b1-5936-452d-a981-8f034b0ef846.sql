...
-- --------------------------------------
-- Automatisches Erstellen aller Chat-Gruppen für alle Städte & Kategorien
-- Kategorien: Kreativität, Ausgehen, Sport
-- Städte-UUIDs werden mit dem in groupIdUtils.ts hinterlegten TRIBE_NAMESPACE & UUIDv5 berechnet
-- ON CONFLICT DO NOTHING verhindert Duplikate
-- --------------------------------------

-- Gruppe(n) für Bielefeld (abbr: BI)
...
-- Gruppe(n) für Berlin (abbr: berlin)
INSERT INTO chat_groups (id, name, description) VALUES
...
-- Gruppe(n) für Bremen (abbr: bremen)
INSERT INTO chat_groups (id, name, description) VALUES
...
-- Gruppe(n) für Dortmund (abbr: dortmund)
INSERT INTO chat_groups (id, name, description) VALUES
...
-- Gruppe(n) für Dresden (abbr: dresden)
INSERT INTO chat_groups (id, name, description) VALUES
...
-- Gruppe(n) für Düsseldorf (abbr: duesseldorf)
INSERT INTO chat_groups (id, name, description) VALUES
...
-- Gruppe(n) für Frankfurt (abbr: frankfurt)
INSERT INTO chat_groups (id, name, description) VALUES
...
-- Gruppe(n) für Hamburg (abbr: hamburg)
INSERT INTO chat_groups (id, name, description) VALUES
...
-- Gruppe(n) für Hannover (abbr: hanover)
INSERT INTO chat_groups (id, name, description) VALUES
...
-- Gruppe(n) für Köln (abbr: cologne)
INSERT INTO chat_groups (id, name, description) VALUES
...
-- Gruppe(n) für Leipzig (abbr: leipzig)
INSERT INTO chat_groups (id, name, description) VALUES
...
-- Gruppe(n) für Lübeck (abbr: luebeck)
INSERT INTO chat_groups (id, name, description) VALUES
...
-- Gruppe(n) für München (abbr: munich)
INSERT INTO chat_groups (id, name, description) VALUES
...
-- Gruppe(n) für Münster (abbr: muenster)
INSERT INTO chat_groups (id, name, description) VALUES
...
-- Gruppe(n) für Nürnberg (abbr: nuremberg)
INSERT INTO chat_groups (id, name, description) VALUES
...
-- Gruppe(n) für Stuttgart (abbr: stuttgart)
INSERT INTO chat_groups (id, name, description) VALUES
...
-- Damit sind alle 51 Kombinationen (17 Städte × 3 Kategorien) abgedeckt
