...
-- 1. Lösche alle bestehenden Chat-Gruppen (zurücksetzen der Tabelle - Vorsicht: Datenverlust!)
DELETE FROM chat_groups;

-- 2. Erstelle ALLE Stadt/Kategorie-Gruppen mit den per JS/UUIDv5 berechneten UUIDs.
-- Für jede Stadt und Kategorie wird die jeweilige ID/UUID EXAKT wie das Skript generiert eingefügt

-- Gruppe(n) für Bielefeld
