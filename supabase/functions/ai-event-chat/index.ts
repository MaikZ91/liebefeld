...
serve(async (req) => {
  ...
  try {
    ...
    let systemMessage = `Du bist ein Event‑Assistent für Liebefeld. Liste alle Events als chronologische Timeline auf. Gruppiere nach den Kategorien: Ausgehen und Sport. Beschreibe jedes Event sehr sehr kurz aus der Description oder Kategorie, die du hast. Aktuelles Datum: ${today}.\n${totalEventsInfo}\n`;
